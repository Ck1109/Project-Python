...
def main():
    ...
    if st.button("submit"):
        ...
        df= pd.DataFrame({'User_ID':[id1] ,'Description':[sentence] , 'Browser_Used':[browser],'Device_Used':[Device],'Is_Response':[res[0]]})

        df.to_csv('Data/train.csv', mode='a',index=False,header=False)
